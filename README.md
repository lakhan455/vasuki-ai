...
## Supabase production v2 migration

Run this file once in Supabase SQL Editor:

```text
backend/supabase/production-v2.sql
```

It enables persistent daily quota, scalable per-message chat storage and
sanitized error-event storage. Backward-compatible fallbacks remain active
until the SQL migration is installed.
